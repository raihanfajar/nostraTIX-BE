...
// Renamed for clarity
export const confirmationTransactionOrganizer = async () => {
  ...
  try {
    ...
    console.log(`[⌚ CRON] ${expiredTransactions.length} transactions have been successfully cancelled and resources restored. 💸`);
